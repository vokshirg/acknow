var page_actions = function(){
    ...
    if ($(".list-group-category.profile-permissions li.admin-of-cat").length > 0 ){
        var aoc = $(".list-group-category.profile-permissions li.admin-of-cat");
        $(".profile-permissions li.admin-of-cat").parents(".cat-openable").addClass("opened");
    ...
    $(".panel-fullscreen").on("click",function(){
        panel_fullscreen($(this).closest(".panel"));
        return false;
    });
    ...
    $(".panel-remove").on("click",function(){
        panel_remove($(this).closest(".panel"));
        $(this).closest(".dropdown").removeClass("open");
        return false;
    });
    ...
    $(".notification-check").on("click",function(){
        panel_remove($(this).closest(".list-group-item"));
        return false;
    });
...
function panel_refresh(panel,action,callback){        
    if(!panel.hasClass("panel-refreshing")){
        ...
        panel.find(".panel-refresh-layer").width(panel.outerWidth()).height(panel.outerHeight());
...
function x_navigation_onresize(){
    ...
    if(inner_port < 769){               
        ...
        $(".page-container").removeClass("page-navigation-toggled-hover");
        ...
        if(inner_port > 768){               
            ...
            $(".page-container").addClass("page-navigation-toggled-hover");
            $(".page-container").addClass("page-navigation-toggled");
            $(".page-sidebar .x-navigation li.active").addClass("active");   
        }        
...
function x_navigation(){
    ...
    $(".filter .dropdown-group a").click(function(event){
        event.stopPropagation();
        event.preventDefault();
        
        
        var dg = $(this).closest('.dropdown-group'); 
        
        if(dg.hasClass("active")){
    ...
    $(".list-group-category li.cat-openable  #need-for-openable").click(function(event){
        event.stopPropagation();

        var li = $(this).closest("li.cat-openable");
...
$(".categories .list-group-item .category-title").click(function(event){
    // event.preventDefault();
    var par = $(this).parent(".list-group-item");
        $(this).parents(".cat-openable").not($(this).parent(".cat-openable")).addClass("opened"); //открываем все родительские категории
