...
$(".articles tr .show-more").on("click", function (){
    var ttd = $(this).closest("td");
    var ohtr = $(this).closest("tr").innerHeight()-20;
    ...
    if (ttd.children(".opened").length > 0) {
        ...
        if (ttd.children(".article-description").length > 0) {
            ...
            var hopened = ttd.children(".article-info").children(".article-description").height() + 90;
            ...
            console.log("htr " + htr);
            console.log("hltd " + hltd);
            console.log("httd " + httd);
